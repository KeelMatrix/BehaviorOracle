...
This report records reproducible synthetic evidence for the bounded .NET semantic domain. It does not validate package publication or every supported operating-system and library combination.
...
Synthetic precision, recall, conservative classification, witness generation, and bounded runtime pass for this corpus. Synthetic truth does not establish real-library value; the pinned real-library evidence and its scope assessment are recorded in [`bench/real-targets.md`](../bench/real-targets.md).
