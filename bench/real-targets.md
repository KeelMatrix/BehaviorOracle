...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| Humanizer.Core | `EQUIVALENT_WITHIN_TESTED_DOMAIN` | 392 / 414 | 392 | 25 | 6.38% | 25 | 32 / 32 | 0 | 0 | 367 | 920.7 ms | byte-identical |
| Newtonsoft.Json | `EQUIVALENT_WITHIN_TESTED_DOMAIN` | 687 / 687 | 687 | 1 | 0.15% | 1 | 32 / 32 | 0 | 0 | 686 | 886.2 ms | byte-identical |
| Npgsql | `EQUIVALENT_WITHIN_TESTED_DOMAIN` | 838 / 839 | 838 | 4 | 0.48% | 4 | 32 / 32 | 0 | 0 | 834 | 986.8 ms | byte-identical |
...
| Bounded runtime suitable for ordinary CI | **PASS** | Synthetic median comparison: 822.9 ms for 80 scenarios; real-target per-scenario medians: 886.2–986.8 ms, with bounded end-to-end JSON runs of about 28.1–36.6 s per 32-scenario target. |
