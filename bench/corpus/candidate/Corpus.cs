...
public static class SemanticChanges
{
    ...
    public static int[] Ordered() => [3, 2, 1];
    ...
    public static async Task<int> AsyncResult(int value) => await Task.FromResult(value + 2);

    public static async ValueTask<int> ValueTaskResult(int value) => await ValueTask.FromResult(value + 2);
